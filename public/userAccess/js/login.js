    ...
    var s = $("#m_login"),
        ...
        e = function () {
            $("#m_login_forget_password").click(function (e) {
                ...
                // document.getElementById("m_login_signup_cancel").style.display = "";
                // document.getElementById("m_login_signup").style.display = "none";
                // console.log('sdsds')
                ...
                // document.getElementById("m_login_signup_cancel").style.display = "none";
                // document.getElementById("m_login_signup").style.display = "";
                e.preventDefault(), o()
            })
        };
    return {
