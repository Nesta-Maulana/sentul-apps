...
<head>
  ...
  <!-- <link rel="stylesheet" href="{!! asset('Mobile-Style/superAdmin/bower_components/bootstrap/dist/css/bootstrap.min.css') !!}"> -->
  <link rel="stylesheet" href="{!! asset('generalStyle/css/bootstrap.min.css') !!}">
  <link rel="stylesheet" href="{!! asset('Mobile-Style/superAdmin/bower_components/font-awesome/css/font-awesome.min.css') !!}">
  <link rel="stylesheet" href="{!! asset('Mobile-Style/superAdmin/bower_components/Ionicons/css/ionicons.min.css') !!}">
  <link rel="stylesheet" href="{!! asset('Mobile-Style/superAdmin/dist/css/AdminLTE.min.css') !!}">
  <link rel="stylesheet" href="{!! asset('Mobile-Style/superAdmin/dist/css/skins/skin-blue.min.css') !!}">
  <style>
  .hidden
  {
      visibility: hidden;
    ...
    <!-- My Css -->
    <link rel="stylesheet" href="{!! asset('Mobile-Style/superAdmin/css/style.css') !!}">
...
<div class="wrapper">
  ...
  <header class="main-header hero">
    ...
    <a href="#" class="logo" style="padding-bottom: 70px;">
      ...
      <span class="logo-lg" style="margin-top: 10px"><img src="{!! asset('generalStyle/images/logo/mixpro-logo.png') !!}" class="mb-1" width="50" height="40" alt="">&ensp;<b>MOLLIE</b></span>
    </a>
    ...
    <section class="sidebar mt-5">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{!! asset('Mobile-Style/img/user.png') !!}" class="rounded-circle" alt="">
        </div>
        <div class="pull-left info">
          <p class="d-flex justify-content-start">Nesta Maulana</p>
          <!--  Status -->
...
<script src="{!! asset('Mobile-Style/superAdmin/dist/js/adminlte.min.js') !!}"></script>
