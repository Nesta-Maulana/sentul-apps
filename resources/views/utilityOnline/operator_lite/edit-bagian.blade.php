...
<div class="container">
    <form action="edit-bagian/data" method="post">
        ...
        <tbody>
            ...
            <?php $id=app('App\Http\Controllers\resourceController')->enkripsi($b->id) ?>
                <tr>
                    ...
                    <a href="master-apps/delete/utility_online/bagian/{{$b->id}}" class="text-white btn btn-danger">Delete</a>
                    </td>
                </tr>
                <?php $i++ ?>
            @endforeach
