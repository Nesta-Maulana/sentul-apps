                        ...
                        <tbody>
                            ...
                            <?php $id=app('App\Http\Controllers\resourceController')->enkripsi($k->id) ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary edit {{ Session::get('ubah') }}" id="edit" data-id="{{ $id }}">Edit</button>
                                        <a href="master-apps/delete/utility_online/kategori/{{$k->id}}" class="text-white btn btn-danger">Delete</a>
                                    </td>
                                    <?php $i++ ?>
                                </tr>
                            @endforeach
