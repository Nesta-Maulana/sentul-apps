@extends('utilityOnline.operator_lite.layouts.app', ['class' => 'login-page', 'page' => __('Login Page'), 'contentClass' => 'login-page'])
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    <img src="{{ asset('utilityOnline/assets') }}/img/card-primary.png" alt="">
