            ...
            <div class="col teks" >
                <div class="row p-3 rounded">
                    <div class="col-lg-4 p-2 teks text-primary">
                        ...
                        <br>
                        <select name="workcenter" id="workcenter" class="form-control select2 text-success">
                            <option value="" selected disabled>-- PILIH WORKCENTER --</option>
                            @foreach($workcenter as $w)
                                <option value="{{ $w->id }}" class="text-dark">{{ $w->workcenter }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-lg-8 teks ">
                        <!--Table-->
                        <table id="tablePreview" class="table bg-dark table-striped table-hover mt-3 tablePreview">
                            <!--Table head-->
