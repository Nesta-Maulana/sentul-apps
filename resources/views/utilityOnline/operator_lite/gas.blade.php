                ...
                <div class="row p-3">
                    <div class="col-lg-4 p-3 teks text-white">
                        ...
                        @foreach($workcenter as $w)
                            <button data-id="{{ $w->id }}" class="btn btn-info d-flex justify-content-center workcenter form-control ">{{ $w->workcenter }}</button><br>
                        @endforeach
                    </div>
...
<script>
    ...
    function workcenter(id) {
        $.ajax({
                url: '/sentul-apps/utility-lite/gas/workcenter/' + id,
                method: 'GET',
                dataType: 'JSON',
    ...
    function simpan(input,idbagian)
    {
        ...
        $.ajax({
            ...
            url: '/sentul-apps/utility-lite/gas/simpan',
            method: 'POST',
            dataType: 'JSON',
