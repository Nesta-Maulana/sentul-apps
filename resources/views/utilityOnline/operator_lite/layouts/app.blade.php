...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- CSS -->
        <link href="{{ asset('utilityOnline/assets') }}/css/black-dashboard.css?v=1.0.0" rel="stylesheet" />
        <link href="{{ asset('utilityOnline/assets') }}/css/theme.css" rel="stylesheet" />
        <script src="{!! asset('masterApps/js/jquery-3.3.1.min.js') !!}"></script>
    </head>
    <body class="{{ $class ?? '' }}">
        @auth()
            <div class="wrapper">
                    @include('utilityOnline.operator_lite.layouts.navbars.sidebar')
                <div class="main-panel">
                    @include('utilityOnline.operator_lite.layouts.navbars.navbar')

                    <div class="content">
                        @yield('content')
                    </div>

                    @include('utilityOnline.operator_lite.layouts.footer')
                </div>
            </div>
        ...
        <div class="fixed-plugin">
            <div class="dropdown show-dropdown">
                ...
                <li class="header-title">Form Lain</li>
