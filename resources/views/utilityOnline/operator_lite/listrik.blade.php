...
<div class="container">
                ...
                <div class="row p-3">
                    <div class="col-lg-4 p-3 teks text-white">
                        ...
                        @foreach($workcenter as $w)
                            <button data-id="{{ $w->id }}" class="btn btn-primary d-flex justify-content-center workcenter form-control " >{{ $w->workcenter }}</button><br>
                        @endforeach
                    </div>
    ...
    function workcenter(id) {
        $.ajax({
                url: '/sentul-apps/utility-lite/listrik/workcenter/' + id,
                method: 'GET',
                dataType: 'JSON',
    ...
    function simpan(input,idbagian)
    {
        ...
        $.ajax({
            ...
            url: '/sentul-apps/utility-lite/listrik/simpan',
            method: 'POST',
            dataType: 'JSON',
