...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-4 mt-4 justify-content-center d-flex">
            <button class="btn btn-success tombol"><a class="text-white" href="utility-online/water"><h1 class="judul">Air</h1></button></a>
        </div>
        <div class="col-lg-4 mt-4 justify-content-center d-flex">
            <button class="btn btn-success tombol"><a class="text-white" href="utility-online/listrik"><h1 class="judul">Listrik</h4></button></a>
        </div>
        <div class="col-lg-4 mt-4 justify-content-center d-flex">
            <button class="btn btn-success tombol"><a class="text-white" href="utility-online/gas"><h1 class="judul">Gas</h1></button></a>
        </div>
        <div class="col-lg-4 mt-4 justify-content-center d-flex">
