            ...
            <div class="form-group">
                ...
                <select name="bagian" id="bagian" class="form-control ">
                    ...
                    @foreach($allBagian as $b)
                        @if($bagian == $b->bagian)
                            <option value="{{ $b->id }}" selected>{{ $b->bagian }}</option>
                        @else
...
<script>
    $.ajax({
        url: '/sentul-apps/utility-online/admin/report-penggunaan/report-grafik/penggunaan/perbulan/'+ {{ $tahun }} +'/'+ {{ $bulan }} +'/' + {{ $idBagian }},
        method: 'get',
        dataType: 'JSON',
