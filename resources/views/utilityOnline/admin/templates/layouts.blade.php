  ...
  <aside class="main-sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- Optionally, you can add icons to the links -->
            ...
            <li class=""><a href='/sentul-apps/edit-bagian' class='active'>Form Bagian</a></li>
            <li class=""><a href='/sentul-apps/satuan' class='active'>Form Satuan</a></li>
            <li class=""><a href='/sentul-apps/kategori' class='active'>Form Kategori</a></li>
            <li class=""><a href='/sentul-apps/workcenter' class='active'>Form Workcenter</a></li>
